...
// (in-package service_client_test.srv)
...
class intsumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type intsumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type intsumRequest
    let len;
    let data = new intsumRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new intsumRequest(null);
...
class intsumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type intsumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type intsumResponse
    let len;
    let data = new intsumResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new intsumResponse(null);
...
module.exports = {
  Request: intsumRequest,
  Response: intsumResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'service_client_test/intsum'; }
};
